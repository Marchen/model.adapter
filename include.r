...
source(file.path(base.path, "model.interface.gam.gam.r"), encoding = "UTF-8")
source(file.path(base.path, "model.interface.gam.mgcv.r"), encoding = "UTF-8")
...
source(file.path(base.path, "model.adapter.prediction.r"), encoding = "UTF-8")
